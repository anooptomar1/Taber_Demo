...
protocol ImageCropperOverlayViewDelegate : class {
    func cropperOverlayViewDidChangeCropRect(_ view: ImageCropperOverlayView, _ cropRect: CGRect)
}

open class ImageCropperOverlayView: UIView {
    
    // MARK: Properties
    
    // Structure configuration for the Overlay View appearance and behavior
    
    open var configuraiton = ImageCropperCropViewConfiguration()
    ...
    weak var delegate: ImageCropperOverlayViewDelegate?
    ...
    // MARK: Initialization of Views & theirs parameters
    
    // Parent (main) class to translate some properties and objects
    
    weak var cropperView: ImageCropperView!
    ...
    public init(configuraiton: ImageCropperCropViewConfiguration? = nil) {
    ...
    open func layoutTopEdgeView(_ view: UIView, inTouchView touchView: UIView, forState state: ImageCropperCropViewTouchState) {
    ...
    open func layoutRightEdgeView(_ view: UIView, inTouchView touchView: UIView, forState state: ImageCropperCropViewTouchState) {
    ...
    open func layoutBottomEdgeView(_ view: UIView, inTouchView touchView: UIView, forState state: ImageCropperCropViewTouchState) {
    ...
    open func layoutLeftEdgeView(_ view: UIView, inTouchView touchView: UIView, forState state: ImageCropperCropViewTouchState) {
    ...
    open func layoutTopLeftCornerView(_ view: UIView, inTouchView touchView: UIView, forState state: ImageCropperCropViewTouchState) {
    ...
    open func layoutTopRightCornerView(_ view: UIView, inTouchView touchView: UIView, forState state: ImageCropperCropViewTouchState) {
    ...
    open func layoutBottomRightCornerView(_ view: UIView, inTouchView touchView: UIView, forState state: ImageCropperCropViewTouchState) {
    ...
    open func layoutBottomLeftCornerView(_ view: UIView, inTouchView touchView: UIView, forState state: ImageCropperCropViewTouchState) {
